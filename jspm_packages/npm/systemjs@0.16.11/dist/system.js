  ...
  !function($__global, $__globalName) {
    $__global.upgradeSystemLoader = function() {
      ...
      function t(t, a) {
        ...
        return v && (a = a.replace(/\\/g, "/")), a = e(a || ""), t = e(t || ""), a && t ? (a.protocol || t.protocol) + (a.protocol || a.authority ? a.authority : t.authority) + r(a.protocol || a.authority || "/" === a.pathname.charAt(0) ? a.pathname : a.pathname ? (t.authority && !t.pathname ? "/" : "") + t.pathname.slice(0, t.pathname.lastIndexOf("/") + 1) + a.pathname : t.pathname) + (a.protocol || a.authority || a.pathname ? a.search : a.search || t.search) + a.hash : null;
      }
      function a(e) {
        function r(e, t) {
          t._extensions = [];
        ...
        if ("undefined" == typeof window && "undefined" == typeof WorkerGlobalScope && "undefined" != typeof process)
          o = "file:" + process.cwd() + "/", v && (o = o.replace(/\\/g, "/"));
      ...
      function n(e) {
        ...
        function i(e) {
          if (!e.register) {
            ...
            e.onScriptLoad = function(e) {
              t(e), v && (e.metadata.entry = v), g && (e.metadata.format = e.metadata.format || "register", e.metadata.registered = !0);
            };
          }
        }
        function s(e, t, a) {
        ...
        function m(e, t, a) {
          ...
          if (r && !r.evaluated && r.declarative) {
            ...
            for (var n = 0,
              ...
              -1 == h.call(t, i) && (a.defined[i] ? m(i, t, a) : a.get(i));
            }
        ...
        e.instantiate = function(e) {
          ...
          if (a.defined[e.name])
            ...
            if (a.global.System = a, a.__exec(e), a.global.System = n, v ? t = v : e.metadata.bundle = !0, !t && p.defined[e.name] && (t = p.defined[e.name]), !g && !e.metadata.registered)
      ...
      function o(e) {
        ...
        e.translate = function(e) {
          ...
          return f.call(t, e).then(function(a) {
            if ("es6" == e.metadata.format || !e.metadata.format && a.match(i))
      ...
      function s(e) {
        ...
        e.instantiate = function(n) {
          return n.metadata.format || (a.lastIndex = 0, r.lastIndex = 0, (r.exec(n.source) || a.exec(n.source)) && (n.metadata.format = "cjs")), "cjs" == n.metadata.format && (n.metadata.deps = n.metadata.deps ? n.metadata.deps.concat(t(n.source)) : t(n.source), n.metadata.executingRequire = !0, n.metadata.execute = function(t, a, r) {
            ...
            i.pop(), i = i.join("/");
            var s = n.address;
            o && s.substr(0, o.length) === o ? (s = s.substr(o.length), i = i.substr(o.length)) : "file:" == s.substr(0, 5) && (s = s.substr(5), i = i.substr(5)), p._nodeRequire && (i = i.substr(5));
            var l = (e.global._g = {
              global: e.global,
              exports: a,
              module: r,
      ...
      function l(e) {
          ...
          function a(a, n, o) {
            ...
            var c = {
              ...
              execute: function(t, a, d) {
                ...
                var m = i.require;
                i.require = p.amdRequire;
                var h = o.apply(i, c);
                return i.require = m, "undefined" == typeof h && d && (h = d.exports), "undefined" != typeof h ? h : void 0;
              }
            };
            if (a)
        ...
        function o(e) {
          ...
          var t = e.global;
          _ = t.module, w = t.exports, z = t.define, t.module = void 0, t.exports = void 0, t.define && t.define === e.amdDefine || (t.define = e.amdDefine);
        }
        function s(e) {
          var t = e.global;
          t.define = z, t.module = _, t.exports = w;
        }
        ...
        e.instantiate = function(e) {
          ...
          if ("amd" == e.metadata.format || !e.metadata.format && e.source.match(d)) {
            if (e.metadata.format = "amd", t.execute !== !1 && (o(t), t.__exec(e), s(t), !y && !x && !u))
      ...
      function c(e) {
        function t(e, t) {
          return Promise.resolve(e.normalize(t)).then(function(r) {
            return -1 == h.call(a, r) && (a.push(r), e.bundles[r] = e.bundles[r] || e.bundles[t], e.meta = e.meta || {}, e.meta[r] = e.meta[r] || {}, e.meta[r].bundle = !0), e.load(r);
          }).then(function() {
            return "";
          });
        }
        ...
        e.fetch = function(e) {
          ...
          for (var o = 0; o < a.length; o++)
            if (-1 != h.call(n.bundles[a[o]], e.name))
              return t(n, a[o]);
          for (var i in n.bundles)
            if (-1 != h.call(n.bundles[i], e.name))
              return t(n, i);
          return r.call(this, e);
        };
      }
      ...
      function m(e) {
        e.depCache = e.depCache || {}, e._extensions.push(m);
        var t = e.locate;
        e.locate = function(e) {
          var a = this;
      ...
      var p,
          ...
          v = "undefined" != typeof process && !!process.platform.match(/^win/);
      !function() {
        var e = $__global.System;
        p = $__global.System = new LoaderPolyfill(e), p.baseURL = e.baseURL, p.paths = {"*": "*.js"}, p.originalSystem = e;
      }(), p.noConflict = function() {
        $__global.SystemJS = p, $__global.System = p.originalSystem;
      };
      var g = $__global.System.originalSystem;
      a(p), r(p), n(p), o(p), i(p), s(p), l(p), u(p), d(p), c(p), f(p), m(p);
    };
    var $__curScript,
        __eval;
    !function() {
