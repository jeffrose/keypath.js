...
(function(process) {
  !function($__global, $__globalName) {
    $__global.upgradeSystemLoader = function() {
      ...
      function t(t, a) {
        ...
        return g && (a = a.replace(/\\/g, "/")), a = e(a || ""), t = e(t || ""), a && t ? (a.protocol || t.protocol) + (a.protocol || a.authority ? a.authority : t.authority) + r(a.protocol || a.authority || "/" === a.pathname.charAt(0) ? a.pathname : a.pathname ? (t.authority && !t.pathname ? "/" : "") + t.pathname.slice(0, t.pathname.lastIndexOf("/") + 1) + a.pathname : t.pathname) + (a.protocol || a.authority || a.pathname ? a.search : a.search || t.search) + a.hash : null;
      }
      function a(e) {
        function r(e, t) {
          t._extensions = [];
        ...
        var o;
        if ("undefined" == typeof window && "undefined" == typeof WorkerGlobalScope && "undefined" != typeof process)
          o = "file:" + process.cwd() + "/", g && (o = o.replace(/\\/g, "/"));
      ...
      function o(e) {
        function a(e) {
          var a,
              r = e.source.lastIndexOf("\n");
          -1 != r && "//# sourceMappingURL=" == e.source.substr(r + 1, 21) && (a = e.source.substr(r + 22, e.source.length - r - 22), "undefined" != typeof t && (a = t(e.address, a))), __eval(e.source, e.address, a);
        }
        function r(e) {
          for (var t = [],
              a = 0,
        ...
        function n(t, a, r, n) {
          "string" != typeof t && (n = r, r = a, a = t, t = null), g = !0;
          var o;
        ...
        function i(e) {
          if (!e.register) {
            ...
            e.onScriptLoad = function(e) {
              t(e), p && (e.metadata.entry = p), g && (e.metadata.format = e.metadata.format || "register", e.metadata.registered = !0);
            };
          }
        }
        function s(e, t, a) {
          ...
          if (!e.module) {
            ...
            for (var o = 0,
              ...
              var s,
                  ...
                  c = t.defined[l],
                  f = b[l];
              f ? s = f.exports : c && !c.declarative ? s = c.module.exports && c.module.exports.__esModule ? c.module.exports : {
        ...
        function c(e, t) {
          var a,
              r = t.defined[e];
          if (r)
            r.declarative ? m(e, [], t) : r.evaluated || f(r, t), a = r.module.exports;
          else if (a = t.get(e), !a)
        ...
        function m(e, t, a) {
          ...
          if (r && !r.evaluated && r.declarative) {
            ...
            for (var n = 0,
              ...
              -1 == v.call(t, i) && (a.defined[i] ? m(i, t, a) : a.get(i));
            }
        ...
        var b = {},
            y = e["delete"];
        e["delete"] = function(e) {
          return delete b[e], y.call(this, e);
        };
        var x = /System\.register/,
            _ = e.fetch;
        e.fetch = function(e) {
          var t = this;
          return i(t), t.defined[e.name] ? (e.metadata.format = "defined", "") : (p = null, g = !1, _.call(t, e));
        };
        var w = e.translate;
        e.translate = function(e) {
          return this.register = n, this.__exec = a, e.metadata.deps = e.metadata.deps || [], Promise.resolve(w.call(this, e)).then(function(t) {
        ...
        e.instantiate = function(e) {
          ...
          if (a.defined[e.name])
            ...
            if (a.global.System = a, a.__exec(e), a.global.System = n, p ? t = p : e.metadata.bundle = !0, !t && h.defined[e.name] && (t = h.defined[e.name]), !g && !e.metadata.registered)
          ...
          return Promise.all(o).then(function(r) {
            return t.normalizedDeps = r, {
              deps: t.deps,
              execute: function() {
                l(e.name, a), m(e.name, [], a), a.defined[e.name] = void 0;
                var r = t.module.exports;
                return (!r || !t.declarative && r.__esModule !== !0) && (r = {
                  "default": r,
                  __useDefault: !0
                }), a.newModule(r);
              }
      ...
      function i(e) {
        function t(e, t, r, n) {
          e.meta = e.meta || {};
          var o = e.meta[t] = e.meta[t] || {};
          if (o.format = o.format || "global", !e.paths[t]) {
            var i = a(r, n);
            i && (e.paths[t] = i);
          }
        }
        function a(e, t) {
          if (d) {
            ...
            try {
              var r = d(e + a);
              return "file:" + r.substr(0, r.length - a.length) + (t ? "/*.js" : "");
            } catch (n) {}
          }
        }
        ...
        var r,
            ...
            l = /babelHelpers\s*\./,
            u = !0,
            d = "undefined" != typeof process && "undefined" != typeof require && require.resolve,
            c = e.locate;
        e.locate = function(e) {
          var a = this;
          return u && ("traceur" == a.transpiler ? (t(a, "traceur", "traceur/bin/traceur.js"), a.meta.traceur.exports = "traceur", t(a, "traceur-runtime", "traceur/bin/traceur-runtime.js")) : "babel" == a.transpiler && (t(a, "babel", "babel-core/browser.js"), t(a, "babel/external-helpers", "babel-core/external-helpers.js"), t(a, "babel-runtime/*", "babel-runtime", !0)), u = !1), c.call(a, e);
        };
        var f = e.translate;
        e.translate = function(e) {
          var t = this;
          return f.call(t, e).then(function(a) {
            if ("es6" == e.metadata.format || !e.metadata.format && a.match(o))
              return e.metadata.format = "es6", a;
            if ("register" == e.metadata.format) {
              if (!t.global.$traceurRuntime && e.source.match(s))
                return t["import"]("traceur-runtime").then(function() {
                  return a;
                });
              if (!t.global.babelHelpers && e.source.match(l))
                return t["import"]("babel/external-helpers").then(function() {
                  return a;
                });
            }
            return "traceur" == t.transpiler ? Promise.all([r || (r = t.normalize(t.transpiler)), n || (n = t.normalize(t.transpiler + "-runtime"))]).then(function(t) {
              return e.name == t[0] || e.name == t[1] ? "(function() { var curSystem = System; " + a + "\nSystem = curSystem; })();" : a;
            }) : a;
          });
        };
      }
      function s(e) {
        ...
        function a(t) {
          if (Object.keys)
            Object.keys(e.global).forEach(t);
          else
            for (var a in e.global)
              i.call(e.global, a) && t(a);
        }
        function r(t) {
          a(function(a) {
            if (-1 == v.call(o, a)) {
            ...
            e.set("@@global-helpers", e.newModule({
              ...
              retrieveGlobal: function(o, i, s) {
                ...
                if (s)
                  ...
                  var c = i.split(".")[0];
                  l = t(i, e.global), d[c] = e.global[c];
                } else
                  r(function(e, t) {
                    a[e] !== t && "undefined" != typeof t && (d[e] = t, "undefined" != typeof l ? u || l === t || (u = !0) : l = t);
                  });
                return n[o] = d, u ? d : l;
              }
            }));
        ...
        var o = ["sessionStorage", "localStorage", "clipboardData", "frames", "external"],
        ...
        e.instantiate = function(e) {
          var t = this;
          n(t);
          var a = e.metadata.exports;
          return e.metadata.format || (e.metadata.format = "global"), "global" == e.metadata.format && (e.metadata.execute = function(r, n, o) {
            t.get("@@global-helpers").prepareGlobal(o.id, e.metadata.deps), a && (e.source += $__globalName + '["' + a + '"] = ' + a + ";");
            var i = t.global.define,
                r = t.global.require;
            return t.global.define = void 0, t.global.module = void 0, t.global.exports = void 0, t.__exec(e), t.global.require = r, t.global.define = i, t.get("@@global-helpers").retrieveGlobal(o.id, a, e.metadata.init);
          }), l.call(t, e);
        };
      }
      function l(e) {
        ...
        var a = /(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF.]|module\.)exports\s*(\[['"]|\.)|(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF.])module\.exports\s*[=,]/,
            r = /(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF."'])require\s*\(\s*("[^"\\]*(?:\\.[^"\\]*)*"|'[^'\\]*(?:\\.[^'\\]*)*')\s*\)/g,
            n = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm;
        if ("undefined" != typeof location && location.origin)
        ...
        e.instantiate = function(n) {
          return n.metadata.format || (a.lastIndex = 0, r.lastIndex = 0, (r.exec(n.source) || a.exec(n.source)) && (n.metadata.format = "cjs")), "cjs" == n.metadata.format && (n.metadata.deps = n.metadata.deps ? n.metadata.deps.concat(t(n.source)) : t(n.source), n.metadata.executingRequire = !0, n.metadata.execute = function(t, a, r) {
            var i = (n.address || "").split("/");
            i.pop(), i = i.join("/");
            var s = n.address;
            o && s.substr(0, o.length) === o ? (s = s.substr(o.length), i = i.substr(o.length)) : "file:" == s.substr(0, 5) && (s = s.substr(5), i = i.substr(5)), h._nodeRequire && (i = i.substr(5));
            var l = (e.global._g = {
              global: e.global,
              exports: a,
              module: r,
      ...
      function u(e) {
        ...
        function n(e) {
          function a(a, n, o) {
            ...
            var c = {
              ...
              execute: function(t, a, d) {
                ...
                var m = s.require;
                s.require = h.amdRequire;
                var p = o.apply(s, c);
                return s.require = m, "undefined" == typeof p && d && (p = d.exports), "undefined" != typeof p ? p : void 0;
              }
            };
            if (a)
              y = 0 != n.length || y || x ? null : c, x = !0, e.register(a, c.deps, !1, c.execute);
            else {
              if (y)
          ...
          e.onScriptLoad = function(e) {
            n(e), (y || x) && (e.metadata.format = "defined", e.metadata.registered = !0), y && (e.metadata.deps = e.metadata.deps ? e.metadata.deps.concat(y.deps) : y.deps, e.metadata.execute = y.execute);
          }, a.amd = {}, e.amdDefine = a;
        }
        function o(e) {
          e.amdDefine || n(e), y = null, x = null;
          var t = e.global;
          _ = t.module, w = t.exports, S = t.define, t.module = void 0, t.exports = void 0, t.define && t.define === e.amdDefine || (t.define = e.amdDefine);
        }
        function i(e) {
          var t = e.global;
          t.define = S, t.module = _, t.exports = w;
        }
        ...
        e.instantiate = function(e) {
          ...
          if ("amd" == e.metadata.format || !e.metadata.format && e.source.match(d)) {
            if (e.metadata.format = "amd", t.execute !== !1 && (o(t), t.__exec(e), i(t), !y && !x && !l))
              throw new TypeError("AMD module " + e.name + " did not define");
            y && (e.metadata.deps = e.metadata.deps ? e.metadata.deps.concat(y.deps) : y.deps, e.metadata.execute = y.execute);
          }
          return $.call(t, e);
        };
      }
      function d(e) {
        ...
        function n(e, n, o) {
          ...
          if (n)
            for (var f in o.map) {
              var m = o.map[f];
              if ("object" == typeof m && t(n, f) && (l = a(f), !(c >= l)))
                for (var p in m)
                  t(e, p) && (u = a(p), d >= u || (i = p, d = u, s = f, c = l));
            }
          if (i)
            return r(e, i.length, o.map[s][i]);
          for (var f in o.map) {
            var m = o.map[f];
            if ("string" == typeof m && t(e, f)) {
              var u = a(f);
              d >= u || (i = f, d = u);
            }
          }
      ...
      function f(e) {
        function t(e, t) {
          return Promise.resolve(e.normalize(t)).then(function(r) {
            return -1 == v.call(a, r) && (a.push(r), e.bundles[r] = e.bundles[r] || e.bundles[t], e.meta = e.meta || {}, e.meta[r] = e.meta[r] || {}, e.meta[r].bundle = !0), e.load(r);
          }).then(function() {
            return "";
          });
        }
        ...
        e.fetch = function(e) {
          ...
          for (var o = 0; o < a.length; o++)
            if (-1 != v.call(n.bundles[a[o]], e.name))
              return t(n, a[o]);
          for (var i in n.bundles)
            if (-1 != v.call(n.bundles[i], e.name))
              return t(n, i);
          return r.call(this, e);
        };
      }
      function m(e) {
        ...
        "undefined" == typeof v && (v = Array.prototype.indexOf), e._extensions.push(m);
        ...
        e.normalize = function(e, t, r) {
          ...
          return Promise.resolve(d.call(this, e, t, r)).then(function(e) {
            ...
            var m = e.substr(0, t),
                p = e.substr(t + 1).split("/")[0],
                h = p.length,
                v = o(e.substr(t + 1).split("/")[0]);
            c = u[e.substr(0, t)] || [], "string" == typeof c && (c = [c]);
            for (var g = c.length - 1; g >= 0; g--)
              if (n(v, a(c[g])))
                return m + "@" + c[g] + e.substr(t + h + 1);
            var b;
            return v.semver ? b = 0 != v.version.major || isNaN(v.version.minor) ? v.version.major : "0." + v.version.minor : v.fuzzy ? b = v.version.major + "." + v.version.minor : (b = p, c.push(p), c.sort(i), u[m] = 1 == c.length ? c[0] : c), m + "@" + b + e.substr(t + h + 1);
          });
        };
      }
      function p(e) {
        e.depCache = e.depCache || {}, e._extensions.push(p);
        var t = e.locate;
        e.locate = function(e) {
          var a = this;
          a.depCache || (a.depCache = {});
          var r = a.depCache[e.name];
          if (r)
      ...
      var h,
          ...
          g = "undefined" != typeof process && !!process.platform.match(/^win/);
      !function() {
      ...
      var b = $__global.System.originalSystem;
      a(h), r(h), n(h), o(h), i(h), s(h), l(h), u(h), d(h), c(h), f(h), m(h), p(h);
    };
    var $__curScript,
        __eval;
    !function() {
      var doEval;
      if (__eval = function(e, t, a) {
        e += "\n//# sourceURL=" + t + (a ? "\n//# sourceMappingURL=" + a : "");
        try {
          doEval(e);
        } catch (r) {
        ...
        if (doEval = function(source) {
          ...
          importScripts(basePath + "es6-module-loader.js"), $__global.upgradeSystemLoader();
        }
      else {
  ...
  }("undefined" != typeof window ? window : "undefined" != typeof global ? global : self, "undefined" != typeof window ? "window" : "undefined" != typeof global ? "global" : "self");
})(require("process"));
