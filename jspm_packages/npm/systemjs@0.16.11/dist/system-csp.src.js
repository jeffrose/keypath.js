...
(function(process) {
  (function($__global, $__globalName) {
    $__global.upgradeSystemLoader = function() {
      ...
      function core(loader) {
        ...
        var baseURI;
        if (typeof window == 'undefined' && typeof WorkerGlobalScope == 'undefined' && typeof process != 'undefined') {
        ...
        loader.translate = function(load) {
          ...
          return loaderTranslate.call(loader, load).then(function(source) {
            ...
            if (loader.transpiler == 'traceur')
              return Promise.all([transpilerNormalized || (transpilerNormalized = loader.normalize(loader.transpiler)), transpilerRuntimeNormalized || (transpilerRuntimeNormalized = loader.normalize(loader.transpiler + '-runtime'))]).then(function(normalized) {
  ...
  })(typeof window != 'undefined' ? window : (typeof global != 'undefined' ? global : self), typeof window != 'undefined' ? 'window' : (typeof global != 'undefined' ? 'global' : 'self'));
})(require("process"));
