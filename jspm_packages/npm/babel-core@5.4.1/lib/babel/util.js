...
function shouldIgnore(filename, ignore, only) {
  ...
  if (only.length) {
    ...
    for (var _i = 0; _i < _arr.length; _i++) {
      var _filename = _arr[_i];var _arr2 = only;
    ...
    for (var _i3 = 0; _i3 < _arr3.length; _i3++) {
      var _filename2 = _arr3[_i3];var _arr4 = ignore;

      for (var _i4 = 0; _i4 < _arr4.length; _i4++) {
        var pattern = _arr4[_i4];
        if (pattern.test(_filename2)) return true;
      }
    }
  }
...
function loadTemplates() {
  ...
  var _arr5 = _fs2["default"].readdirSync(templatesLoc);
