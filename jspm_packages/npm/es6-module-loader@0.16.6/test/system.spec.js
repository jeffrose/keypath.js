    ...
    describe('#import', function() {
      describe('an ES5 script', function() {
        ...
        it('should import a ES5 script once loaded', function(done) {
          System.import('test/syntax/script').then(function() {
            return System.import('test/syntax/script').then(function(m) {
              expect(!!m).to.be.ok();
            });
          }).then(done, done);
        });
      ...
      describe('errors', function() {
        ...
        it('should throw if on syntax error', function(done) {
          System.import('test/loads/main').then(supposeToFail).catch(function(e) {
            expect(e).to.be.equal('Error evaluating test/loads/deperror\ndep error');
          }).then(done, done);
        });
        it.skip('should throw what the script throws', function(done) {
          System.import('test/loads/deperror').then(supposeToFail).catch(function() {
            expect(false, 'should be successful ??').to.be.ok();
          }).then(done, done);
        });
        it('Unhandled rejection test', function(done) {
          System.import('test/loads/load-non-existent').then(supposeToFail).catch(function(e) {
